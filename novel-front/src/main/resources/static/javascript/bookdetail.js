var BookDetail = {
    ...
    DescriptionMore: function (sClass) {
        if (sClass == "") {
            if ($("#pDesMore").html().length > 500) {
                $("#divDescription").html($("#pDesMore").html().substring(0, 500) + "<a href=\"javascript:void(0);\" class=\"info_txt_more\" onclick=\"javascript:BookDetail.DescriptionMore('down');\">Tarik<img src=\"../images/arrow_d.png\" /></a>");
            } else {
